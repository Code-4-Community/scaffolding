...
- Rename copy to EXACTLY `.env` - If you name it anything else you risk leaking security credentials!

## Running the application
- To run just the frontend (port 4200): `nx serve frontend`
- To run just the backend (port 3000): `nx serve backend`
- Run both in the same terminal: `nx run-many -t serve -p frontend backend`
