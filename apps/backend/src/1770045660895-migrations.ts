...
export class Migrations1770045660895 implements MigrationInterface {
  name = 'Migrations1770045660895';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "storydrafts" ("id" SERIAL NOT NULL, "docLink" character varying NOT NULL, "submissionRound" integer NOT NULL, "studentConsent" boolean NOT NULL, "inManuscript" boolean NOT NULL, "editRound" integer NOT NULL, "proofread" boolean NOT NULL, "notes" text array NOT NULL, "authorId" integer, CONSTRAINT "PK_39aaf376a55cf146f7e817faccc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "storydrafts" ADD CONSTRAINT "FK_37a412a16d6dde8523a6ee952dc" FOREIGN KEY ("authorId") REFERENCES "authors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "storydrafts" DROP CONSTRAINT "FK_37a412a16d6dde8523a6ee952dc"`,
    );
