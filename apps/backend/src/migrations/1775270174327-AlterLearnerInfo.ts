...
export class AlterLearnerInfo1775270174327 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."learner_info_school_enum" AS ENUM('BIDMC - Residents', 'BMC Addiction Medicine', 'BMC - Family Medicine', 'BMC School of Medicine - Center for Multicultural Training in Psychology', 'Boston College - Lynch School of Education and Human Development', 'Boston Graduate School of Psychoanalysis', 'Boston University', 'Boston Medical Center Grayken Center', 'Boston University School of Medicine Division of Graduate Medical Sciences physician assistant program', 'BU Mental Health Counseling and Behavioral Medicine Program', 'BWH Addiction Medicine', 'Capella University', 'Fisher College', 'Georgetown University School of Medicine', 'Johns Hopkins', 'Laboure College', 'Medex Northwest PA', 'MGH Addiction Medicine', 'MGH Pediatric Residency Program', 'Michigan State University', 'Northeastern', 'Northeastern Bouve College of Health Sciences', 'Norwich University', 'Salem State', 'State University of New York', 'UMass Boston - NP/PA', 'UMass Boston - Nursing', 'University of Washington School of Medicine', 'Western Governors University', 'Worcester State University', 'Other', 'Does not apply')`,
    );
    await queryRunner.query(
