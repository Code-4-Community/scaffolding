...
export const MOCK_AUTHORS: Author[] = [
  ...
  // Smoke-test authors (ids 27–33)
  { id: 27, name: 'Priya Nair' },
  { id: 28, name: 'D. Washington' },
  { id: 29, name: 'R. Mensah' },
  { id: 30, name: 'J. Carvalho' },
  { id: 31, name: 'N. Okonkwo' },
  { id: 32, name: 'T. Adeyemi' },
  { id: 33, name: 'C. Osei' },
];
...
export const MOCK_STORIES: Story[] = [
  ...
  // Smoke-test stories (ids 28–40, mirror smoke-test anthologies 11–22)
  { id: 28, title: 'Story 1', anthologyId: 11, authorId: 16 },
  { id: 29, title: 'Story 2', anthologyId: 11, authorId: 17 },
  { id: 30, title: 'Story 1', anthologyId: 12, authorId: 27 },
  { id: 31, title: 'Story 1', anthologyId: 13, authorId: 28 },
  { id: 32, title: 'Story 1', anthologyId: 14, authorId: 29 },
  { id: 33, title: 'Story 1', anthologyId: 15, authorId: 20 },
  { id: 34, title: 'Story 1', anthologyId: 16, authorId: 23 },
  { id: 35, title: 'Story 1', anthologyId: 17, authorId: 24 },
  { id: 36, title: 'Story 1', anthologyId: 18, authorId: 26 },
  { id: 37, title: 'Story 1', anthologyId: 19, authorId: 30 },
  { id: 38, title: 'Story 1', anthologyId: 20, authorId: 31 },
  { id: 39, title: 'Story 1', anthologyId: 21, authorId: 32 },
  { id: 40, title: 'Story 1', anthologyId: 22, authorId: 33 },
];
...
export const STATIC_ARCHIVED: Anthology[] = [
  ...
  // ── Smoke-test data (ids 11–22) ────────────────────────────────────────────
  // Added to exercise filter/sort dimensions. Each entry has explicit values for
  // pub_level, programs, genre, inventory, and published_year so that every enum
  // value is represented at least twice. Do not use these as a source of truth.
  {
    id: 11,
    title: 'Mystery at Mattapan',
    description: '',
    published_year: 2023,
    status: AnthologyStatus.ARCHIVED,
    pub_level: AnthologyPubLevel.ZINE,
  ...
  },
  {
    ...
    pub_level: AnthologyPubLevel.CHAPBOOK,
    genres: ['Mystery'],
    programs: 'STEM Literacy',
    inventory: 45,
  },
  {
    id: 14,
    title: 'Hearts of the Harbor',
    description: '',
    published_year: 2020,
    status: AnthologyStatus.ARCHIVED,
    pub_level: AnthologyPubLevel.CHAPBOOK,
  ...
  {
    id: 15,
    title: 'Laughing Through Learning',
    description: '',
    published_year: 2023,
    status: AnthologyStatus.ARCHIVED,
    pub_level: AnthologyPubLevel.PERFECT_BOUND,
    genres: ['Comedy'],
    programs: 'School Partnership',
    inventory: 80,
  },
  {
    id: 16,
    title: 'Tales of Old Boston',
    description: '',
    published_year: 2019,
    status: AnthologyStatus.ARCHIVED,
    pub_level: AnthologyPubLevel.PERFECT_BOUND,
  ...
  {
    id: 19,
    title: 'Neighborhood Zine Vol. 1',
    description: '',
    published_year: 2019,
    status: AnthologyStatus.ARCHIVED,
    pub_level: AnthologyPubLevel.ZINE,
    genres: ['Historical Fiction'],
    programs: "Writer's Room",
    inventory: 10,
  },
  {
    id: 20,
